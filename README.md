...
**Faz 0: Planlama — belgeler tamamlandı.** Kod yazılmadan önce kapsam, terimler, iş kuralları, veri modeli, mimari, standartlar ve çalışma süreci belgelendi. Sırada repo'nun herkese açılması ve Faz 1 (geliştirme altyapısı ve ilk modüller).
...
| [07 — Teknoloji yığını](docs/07-tech-stack.md) ve [ADR'ler](docs/adr/README.md) | v1.7 |
...
| Çalışma süreci: [arayüz standardı](docs/standards/ui.md) · [11 — Ekran şablonları ve envanteri](docs/11-screens.md) | Tamamlandı |
