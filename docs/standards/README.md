...
| [code-style.md](code-style.md) | Kod biçimi, yazım kuralları, analizörler ve lint araçları | v1.5 |
...
| [ci.md](ci.md) | Sürekli entegrasyon: iş akışları, PR hattı, gece ve haftalık işler, yayın hattı, iş akışı güvenliği, lisans ve açık denetimi | v1.1 |
