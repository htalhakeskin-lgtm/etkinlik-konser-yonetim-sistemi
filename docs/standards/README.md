...
| Belge | Kapsam | Durum |
|---|---|---|
| [naming.md](naming.md) | Koddaki, veritabanındaki, API'deki ve ön yüzdeki adlar; sözlükten diğer biçimlere dönüşüm | v1.5 |
| [code-style.md](code-style.md) | Kod biçimi, yazım kuralları, analizörler ve lint araçları | v1.8 |
...
| [git.md](git.md) | Dal düzeni, commit mesajları, PR ve birleştirme, görev takibi, sürüm numaraları, commit kancaları, bağımlılık güncellemeleri, gizli bilgi taraması, repo ayarları | v1.4 |
| [testing.md](testing.md) | Test katmanları, değişiklik türüne göre gereken testler, kural izlenebilirliği, test verisi, kararsız testler, kod kapsamı | v1.3 |
